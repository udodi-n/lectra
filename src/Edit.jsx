    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-[#1c1c1c] font-[Instrument_Sans]  ">
            ...
            <div className='h-160 w-4/5 flex flex-col bg-white rounded-4xl justify-center items-center overflow-hidden '>
                ...
                {/* Details Start */}
                <form onSubmit={updateLectureEntry} className="w-4/5 justify-center items-center flex flex-col flex-1 gap-4">
                    <select 
                    required
                    ...
                    <button className='px-3 py-2 mt-3 bg-[#1c1c1c] text-white w-full '>Update Post</button>
                </form>
                    </div>
                </div>
    )
